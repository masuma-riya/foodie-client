...
import BiryaniImg1 from "../../../assets/images/biryani3.png";
import BiryaniImg2 from "../../../assets/images/biryani5.png";
import BiryaniImg3 from "../../../assets/images/biryani2.png";
        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <div>
                <button className="bg-yellow-500 font-semibold text-base hover:scale-105 duration-200 text-white py-2 px-4 rounded-full">
                  Order Now
                </button>
              </div>
            </div>
            ...
            <div className="min-h-[450px] sm:min-h-[450px] flex justify-center items-center relative order-1 sm:order-2 ">
              <div className="h-[300px] lg:mr-4 sm:h-[450px] overflow-hidden flex justify-center items-center">
                <img
                  data-aos="zoom-in"
