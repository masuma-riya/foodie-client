      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
          <a className="flex items-center justify-center ">
            ...
            <p className="text-4xl italic px-2 font-bold text-white">Foodie</p>
          </a>
          <ul className="text-lg text-center sm:flex items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
            ...
            <li>
              <a className="text-white hover:text-gray-400">Resources</a>
            </li>
            <li className="sm:my-0 my-2">
              <a className="text-white hover:text-gray-400">Blog</a>
            </li>
            <li>
              <a className="text-white hover:text-gray-400">Support</a>
            </li>
          </ul>
          <div className="flex  space-x-4 sm:justify-center  ">
            <a className="w-9 h-9 rounded-full  flex justify-center items-center bg-indigo-600">
              <svg
        ...
        <div className="py-7 border-t border-gray-700">
          <div className="flex items-center justify-center">
            <span className="text-gray-400 text-2xl italic">
              © <a>Foodie</a> {currentYear}, All rights reserved.
            </span>
          </div>
        </div>
      </div>
